...
function drawval(part){
  ...
  if(uploadbutton == "clicked"){
    ...
    socket.emit("uploadimage", part.myid, part.myimagearray.data)
...
socket.on("uploadedimage", (path, newid) => {
  path = path.split("/");

  console.log(path + " < path " + newid + " <newid");
